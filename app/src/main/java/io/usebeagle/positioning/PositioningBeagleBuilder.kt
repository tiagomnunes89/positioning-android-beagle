...
import io.usebeagle.positioning.beagle.TEXT_WHITE_BUTTON
import io.usebeagle.positioning.beagle.TEXT_WHITE_MEDIUM
import io.usebeagle.positioning.beagle.TEXT_WHITE_EXTRA_LARGE
import io.usebeagle.positioning.beagle.TEXT_WHITE_LARGE
...
object PositioningBeagleBuilder {
    fun build() = Screen(
        child = ScrollView(
    ...
    private fun red() =
        Container(
            children = listOf(
                Text(
                    text = "1",
                    styleId = TEXT_WHITE_EXTRA_LARGE,
    ...
    private fun green() = Container(
        ...
        Style(
            ...
            margin = EdgeValue(top = 30.unitReal(), bottom = 16.unitReal()),
            flex = Flex(
                flexDirection = FlexDirection.ROW,
